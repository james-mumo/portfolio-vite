...
const Contact = () => {
  ...
  return (
    <div id="contact" className="h-fit w-full flex flex-col pt-10 px-0">
      ...
      {/*  */}
      {/*  */}
      <span className="markup ml-16 text-sm">&lt;div&gt;</span>
      <div className="flex w-full gap-10 justify-between mt-3">
        <div className="flex flex-1 flex-col">
          ...
          <span className="bg-[#01d29313] flex flex-col gap-4 p-6 justify-center items-center">
      ...
      <div className="flex items-center w-full py-0 justify-center">
        <span>
          Made with ❤ by
      ...
      <span className="markup ml-10 text-sm">&lt;/section&gt;</span>
    </div>
  )
}
